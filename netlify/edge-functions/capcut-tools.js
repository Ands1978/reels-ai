  ...
  function injectPanel(){
    ...
    input.parentElement.insertAdjacentHTML('afterend', `
      <div id="reelsAiToolsPanel" class="notice" style="margin-top:12px">
        <b>🧰 FERRAMENTAS IA INTEGRADAS</b>
        <div class="buttons" style="margin-top:10px">
          <button id="toolMusic" class="secondary">🎵 Eleven Music</button>
          <button id="toolVoice" class="secondary">🎙️ ElevenLabs Voz</button>
        ...
        <div class="hint" style="margin-top:8px">Os botões abrem as ferramentas oficiais e copiam automaticamente um prompt pronto baseado no tema do Reel.</div>
      </div>
      <div id="reelsAiToolsNotice" class="notice">🎵 <b>Música:</b> o MusicGen gratuito foi removido. Agora o fluxo usa <b>Eleven Music</b>, que aceita prompts para trilhas instrumentais e música para vídeo.</div>
    `);
